...
function myFunction() {
    return "wow this is a random function... but it works!";
}
...
myArrowFunction = () => "this is a random arrow function!";
...
console.log(stringToUpper("this is a string to uppercase function, woooop"));
